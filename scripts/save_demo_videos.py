...
def playback_dataset(args):
    ...
    if args.video_path is None:
        ...
        video_dir = args.dataset_dir + "_icml"
    ...
    for ind in range(len(demos)):
        ...
        images = f["data/{}/obs/agentview_rgb".format(ep)][()]
        images = np.array(images)[1:, ::-1]

        video_writer = imageio.get_writer(
            os.path.join(video_dir, "agentview.mp4"),
            fps=20,
        )
        ...
        video_writer.close()
        np.savez_compressed(
            os.path.join(video_dir, "actions.npz"),
            actions=actions,
        )
...
if __name__ == "__main__":
    ...
    args.dataset_dir = "/net/holy-isilon/ifs/rc_labs/ydu_lab/xczhang/DiffRL/libero_dataset/LIBERO/libero/datasets/libero_10"
